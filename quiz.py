...
print(
    "What is the syntax for writing comments in Python?"
    "\n A. # \n B. /* \n C. */ \n D. //)"
)
...
if Q1 == "A":
    ...
    print("You answered question 1 incorrectly")
...
if Q2 == "A":
    ...
    print("You answered question 2 incorrectly")
...
if Q3 == "C":
    ...
    print("You answered question 3 incorrectly")
